...
class NeuralNetMLP:
    ...
    def backward(self, x, a_h1, a_h2, a_out, y):  
        ...
        ## = DeltaOut * dOutNet/dHiddenAct * [dHiddenAct/dHiddenNet * dHiddenNet/dWeight] X 2
...
eval.plot_roc(int_to_onehot(y_test,10), probas, model_name='MLP2hidden')
